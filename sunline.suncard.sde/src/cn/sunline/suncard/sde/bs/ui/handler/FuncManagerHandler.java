 ...
 * @since     1.0 
 */
public class FuncManagerHandler extends AbstractHandler {
	Log log = LogManager.getLogger(FuncManagerHandler.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			page.showView(IAppconstans.FUN_MANAGER_VIEW_PART_ID);
			//展开功能树
			treeViewer.expandToLevel(new FunctionTree(I18nUtil.getMessage("FUNCTION_MANAGER"), BsFunction.class), 2);
		} catch (PartInitException e) {
			e.printStackTrace();
