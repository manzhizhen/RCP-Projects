...
public class SearchAction extends Action {
	public SearchAction(){
		setId(IAppconstans.SEARCH_ACTION_ID);
		setText(I18nUtil.getMessage("search"));
		setAccelerator(SWT.CTRL+'F');
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(IAppconstans.APPLICATION_ID, IImageKey.SEARCH_ACTION));
	}
