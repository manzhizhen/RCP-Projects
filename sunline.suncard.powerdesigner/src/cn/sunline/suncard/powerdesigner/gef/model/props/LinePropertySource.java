...
public class LinePropertySource  extends AbstractPropertySource{
	private LineGefModel lineModel;
	
	public LinePropertySource(LineGefModel lineModel) {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		IPropertyDescriptor[] props = new IPropertyDescriptor[]{new TextPropertyDescriptor(
				LineGefModel.PROP_ID_LABEL, I18nUtil.getMessage("LINE_NAME"))};
	...
	public Object getPropertyValue(Object id) {
		if (id.equals(LineGefModel.PROP_ID_LABEL)) { 
