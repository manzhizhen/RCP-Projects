...
import cn.sunline.suncard.sde.workflow.gef.xml.LineXmlProperty;
...
public abstract class AbstractLineModel extends AbstractListenerModel implements IAdaptable, Cloneable, java.io.Serializable{
	private AbstractModel source;
	private AbstractModel target;
	
//	private Color linkColor = ColorConstants.black;		// 连接线颜色
	 ...
	 */
	public static AbstractLineModel abstractLineFactory(String type) {
		if(type == null) {
			return null;
		}
		
		if(type.equals(LineModel.class.getName())) {
